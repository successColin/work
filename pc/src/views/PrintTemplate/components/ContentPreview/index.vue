...
export default {
  ...
  methods: {
    ...
    getPageRowNum() {
      ...
      this.pageRowNum = lastConst.r;
      if (this.type === 2) {
        console.log(this.pageRowNum, this.pageRowTop, this.pageRowBottom);
        this.pageRowNum = this.pageRowNum - this.pageRowTop - this.pageRowBottom + 1;
      }
    },
    // 每页多少高度
    getContentHeight() {
