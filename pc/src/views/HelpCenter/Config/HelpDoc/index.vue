    ...
    <edit-drawer
      ...
      :placeholder="
        $t('placeholder.pleaseEnterAny', {
          any: this.$t('helpCenter.helpDocumentTitle'),
        })
      "
  ...
  computed: {
    ...
    drawerTitle() {
      return this.isAddDrawerState
        ? this.$t('common.add', { name: this.$t('helpCenter.helpDocument') })
        : this.$t('common.edit', { name: this.$t('helpCenter.helpDocument') }); // '新增帮助文档' : '编辑帮助文档';
    },
    // 多选数据ids的集合
    multiIdsString() {
      let str = '';
