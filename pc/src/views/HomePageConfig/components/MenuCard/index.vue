    ...
    <div class="menuCard__normal" v-if="curState === 1">
      ...
      <div class="menuCard__bottom">
        ...
        <transition name="move-left">
          <div
            class="menuCard__iconSet"
            v-show="isHover && !isMoving"
          ...
          >
            ...
            <el-tooltip
              ...
              placement="bottom"
            >
              <i class="iconfont icon-fuzhi" @click.stop="copyMenu"></i>
            </el-tooltip>
            <el-tooltip
              effect="dark"
...
<script>
import { copyMenu } from '@/api/homePage';
...
export default {
  ...
  methods: {
    ...
    enterMenuRole() {
      ...
      this.$router.replace(`/homeMenuConfig/${this.item.id}`);
    }
  },
