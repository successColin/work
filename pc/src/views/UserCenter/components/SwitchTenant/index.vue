...
<script>
import { getPersonalCenterTenantList, switchPersonalCenterTenant } from '@/api/userCenter.js';
...
export default {
  ...
  methods: {
    ...
    switchTenant(item) {
      ...
      const str = `${this.$t('userCenter.switchTenant')}:(${this.$t('userCenter.tenantName')}:${
        item.tenantName
      })`;
      params.logData = str;
