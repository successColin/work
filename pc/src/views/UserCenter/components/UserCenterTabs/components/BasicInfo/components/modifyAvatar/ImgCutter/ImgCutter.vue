          ...
          >
            ...
            >
              <div class="toolMain">
                ...
                <div class="imgTips">
                  {{ $t('userCenter.avatarUploadTips2') }}
                </div>
              </div>
          ...
          let timmer = setInterval(function () {
            if (reader.readyState == 2) {
              ...
              if (
                !_this.sizeChange &&
                _this.smallToUpload &&
                img.width <= _this.cutWidth &&
                img.height <= _this.cutHeight
              ) {
                _this.handleClose();
