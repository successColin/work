...
// 密码安全校验两种
// export const securityCheckTwo = /^(?![a-zA-z]+$)(?!\d+$)(?![!@#$%^&*]+$)[a-zA-Z\d!@#$%^&*]+$/;
export const securityCheckTwo = /^(?![A-Z]+$)(?![a-z]+$)(?!\d+$)(?![\W_]+$)\S+$/;

// 密码安全校验三种
// export const securityCheckThree = /^(?![a-zA-z]+$)(?!\d+$)
// (?![!@#$%^&*]+$)(?![a-zA-z\d]+$)(?![a-zA-z!@#$%^&*]+$)
// (?![\d!@#$%^&*]+$)[a-zA-Z\d!@#$%^&*]+$/;
export const securityCheckThree = /^(?![a-zA-Z]+$)(?![A-Z0-9]+$)(?![A-Z\W_]+$)(?![a-z0-9]+$)(?![a-z\W_]+$)(?![0-9\W_]+$)[a-zA-Z0-9\W_]{6,18}$/;
