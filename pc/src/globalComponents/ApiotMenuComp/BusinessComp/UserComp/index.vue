...
const userDialog = () => import('_v/orgManage/components/detail/components/userDialog');
    ...
    async initData() {
      if (this.cardData) {
        if (this.cardData[this.configData.compId]) {
          const params = {
            selectContent: 'account,email,enabled,icon,id,memo,orgId,telephone,username,wechat',
            selectFrom: 'sys_user',
