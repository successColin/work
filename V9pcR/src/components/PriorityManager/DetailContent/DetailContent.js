    ...
    if (!activeTreeNodeDetail.isGroup || actionType === 'addElement') {
      publicBasicConfig = [
        basicLine, {
          ...
          key: 'id',
          colSpan: 12,
          label: <FormattedMessage id="global.columnCommentId"/>,
          config: {
        ...
        // config: {
        //   initialValue: activeDetail.typeName || '',
        // },
        // component: (
        //   <NormalSearchSelect
        //     type="type"
        //     currentKey={activeDetail.typeId + '-ORGANIZATION'}
        //     currentId={activeDetail.typeId}
        //     setSelected={selecteds => this.getTypeName(selecteds, 'typeName', 'typeId')}
        //   />
        // ),
        // },{ // 类型id
        //   key: 'typeId',
        ...
        //   colSpan: 12,
        //   config: {
        //     initialValue: activeDetail.typeId,
        //   },
        //   component: (
