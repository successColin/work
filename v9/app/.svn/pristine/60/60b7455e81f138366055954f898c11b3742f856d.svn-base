...
function parseQueryString(query) {
  ...
  for (var i = 0, ii = parts.length; i < ii; ++i) {
	...
	console.log(value + param[2])
    params[decodeURIComponent(key)] = decodeURIComponent(value +'='+ param[2]);
  }
...
function getViewerConfiguration() {
  return {
    ...
    defaultUrl: 'http://v9.mingcloud.top:8080/eam/images/files/2020/3/25/0915141f-2786-4443-ba75-9e39a6a5be3c.pdf?token=cd72199d-8453-4fcc-8a4d-f97fdb2f0bc9'
  };
}
