...
import { SPECIAL_CHARACTERS } from '@/constants/global';
...
class FilterForm extends Component {
  ...
  setElementToWidget = (eleObj, valueObj = {}, formKey) => {
    ...
    if (basetype === 1) {
      const _props = {
        ...baseProps,
        onBlur: e => this.changeCondSelect(e.target.value ? e.target.value.replace(SPECIAL_CHARACTERS, '') : '', id, elementPramDto),
      };
      const _numProps = {
        ...baseProps,
