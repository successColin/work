 ...
 * @Last Modified time: 2019-10-25 16:06:13
 * @Desc: 界面配置右侧主内容
 */
...
class ContentContainer extends Component {
  ...
  addActiveModule = ({ selectedRows }) => {
    ...
    newElementList.push(selectedRows[0]);
    updateFrameState({
      activeDetail: {
        ...activeDetail,
  ...
  render() {
    const { form, activeDetail = {}, activeTreeNodeDetail = {}, actionType, loading, isInitialData, updateFrameState } = this.props;
    const { elementList = [] } = activeDetail;
