...
<template>
  <view class="healtyJump">
    <!-- 导航栏 -->
    <apiot-navbar v-if="!hasDing" :title="barTitle"></apiot-navbar>
...
export default {
  ...
  onLoad(options) {
    ...
    const urlArry = [troubleDate, planKeepDate, pointDate,
      enforceDate, equHealthDate, downtimeDate, frequencyDate];
