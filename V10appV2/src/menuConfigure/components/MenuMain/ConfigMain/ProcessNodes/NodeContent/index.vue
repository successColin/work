...
<template>
  <view>
    <section class="nodeContent">
      <image
        v-if="content.executCommand === 'AGREE'"
        class="nodeContent__state"
        src="~@/static/img/app/pass.svg"
        alt=""
      />
      <image
        v-if="content.executCommand === 'REJECT'"
        class="nodeContent__state"
        src="~@/static/img/app/reject.svg"
        alt=""
      />
      ...
      <p
        ...
        v-if="
          (content.executCommand === 'AGREE' && content.memo) ||
          (content.executCommand === 'REJECT' && content.memo)
        "
      >
        审批意见：{{ content.memo }}
      </p>
      ...
      <!-- nodeContent__explain -->
      <p class="nodeContent__time tip" v-if="multiApprovalType">
