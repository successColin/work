  ...
  <div class="messageList">
    <div class="header">
      <view class="commandSelect">
        ...
        <picker
          class="commandPicker"
          @change="handleMessageType"
          :value="messageType"
          range-key="label"
          :range="messageTypeArr"
        >
          <view class="command">
            {{ messageTypeArr[messageTypeIndex].label }}
            <i class="appIcon appIcon-xialasanjiao"></i>
          </view>
        </picker>
      </view>
  ...
  methods: {
    ...
    getPageInnerMailList() {
      try {
        ...
        if (this.messageType && this.messageType !== 'all') {
          param.innerMailCategory = this.messageType;
        }
    ...
    handleMessageType(e) {
      ...
      this.messageType = this.messageTypeArr[value].key;
      this.messageArr = [];
      this.page = 1;
      this.getPageInnerMailList();
    },
