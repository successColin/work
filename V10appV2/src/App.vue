...
// #ifndef MP
// @import url('https://at.alicdn.com/t/c/font_2808920_6p56jqmr97.css'); // app独有
// @import url('https://at.alicdn.com/t/c/font_3589589_lwag9mymt1.css'); // 图标库纯色
@import '@/assets/css/iconfont/APP/appIconfont/iconfont.css'; // app独有
@import '@/assets/css/iconfont/APP/commonSolid/iconfont.css'; // 图标库纯色
// #endif
// #ifdef MP
@import '@/assets/css/iconfont/appIconfont.css'; // app独有
@import '@/assets/css/iconfont/commonSolid.css'; // 图标库纯色
//#endif
@import '@/assets/css/iconfont/commonColour.css'; // 彩色
@import '@/assets/css/iconfont/commonColour2.css'; // 彩色库2
