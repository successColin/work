...
<template>
  <view class="basic">
    ...
    <view class="header" v-if="announceGroupList.length">
      <view
        class="group"
        v-for="item in announceGroupList"
        :style="{ fontFamily: 'appIcon',
          color: currentGroup.id === item.id ? themeColor : '#333333',
          borderBottom: currentGroup.id === item.id ? `4px solid ${themeColor}` : '' }"
        :key="item.id"
    ...
    <view class="basic__content">
      ...
      >
        ...
        <view class="notdata" v-if="announceList.length === 0">
