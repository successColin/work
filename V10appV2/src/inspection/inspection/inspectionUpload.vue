<template>
  <view class="inspection-upload">
    ...
    <apiot-prompt
      ...
      :placeholder="$t('inspection.inspection-enterTime')"
    >
    </apiot-prompt>
  </view>
</template>
...
import { uploadInspectionTask } from '@/api/inspection.js';
