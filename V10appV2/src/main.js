// 全局组件注册
import Location from '@/utils/app/location.js';
...
import ApiotFixed from '@/globalComponents/ApiotFixed';
...
import ApiotMenuProcess from '@/menuConfigure/components/MenuMain/ConfigMain/ConfigBtns/ProcessOP/MenuConfig.vue';

Vue.component('ApiotFixed', ApiotFixed);
...
Vue.component('ApiotMenuProcess', ApiotMenuProcess);
