        ...
        >
          <view v-if="!isRange" class="uni-date-x uni-date-single">
            ...
            <input
              ...
              :disabled="true"
              placeholder-class="uni-date__placeholder"
            />
...
export default {
  ...
  computed: {
    ...
    singlePlaceholderText() {
      return (
        this.placeholder ||
        (this.type === 'date' ? this.selectDateText : t('uni-datetime-picker.selectDateTime'))
      );
    },
  ...
  methods: {
    ...
    initPicker(newVal) {
      ...
      if (!Array.isArray(newVal) && !this.isRange) {
        ...
        this.startMultipleStatus = { ...this.startMultipleStatus, ...defaultRange, which: 'right' };
        this.endMultipleStatus = { ...this.endMultipleStatus, ...defaultRange, which: 'left' };
      }
    },
    updateLeftCale(e) {
    ...
    leftChange(e) {
      ...
      this.startMultipleStatus = { ...this.startMultipleStatus, ...obj };
    },
    ...
    rightChange(e) {
      ...
      this.endMultipleStatus = { ...this.endMultipleStatus, ...obj };
    },
    ...
    parseDate(date) {
      ...
      const defTime = `${this.lessTen(hour)}:${this.lessTen(minute)}${
