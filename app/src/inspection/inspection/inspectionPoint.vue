        ...
        >
          <view class="detail-form">
            ...
            <view class="basic-info" v-if="item.taskType != 999">
              ...
              <view class="basic-info-item" :key="obj.id"
                v-for="obj in taskConfigByType(item.taskType, 1, 2)">
                <text class="label-text">{{ obj.columnTitle }}：</text
                ><!-- 中文：巡检方法 -->
                <text class="value-text">{{ item[obj.columnObj.columnName] }}</text>
              </view>
              <!-- 中文：计划开始时间 -->
              <!-- <view class="basic-info-item">
            ...
            <!-- 润滑 -->
            <view class="basic-content-info" v-else-if="item.taskType == 3
              && taskConfigByType(3, 1, 1).length">
              <view class="info-item">
                <text class="label-text"
            ...
            <view class="basic-content-info" v-if="item.taskType != 999">
              <view class="info-item info-textarea" :key="obj.id"
            ...
            <view class="img-files">
              ...
              ><i class="appIcon appIcon-tianjiagongneng"></i></view>
              <view
              ...
              >
                ...
                ></image>
                <i class="appIcon appIcon-guanbi delImg"
                  @click="handleDeleteImg(index, imgIndex)"></i>
                <!-- <m-font-icon
                  icon="iconqingchu"
                  :iconSize="30"
                  color="#ADADAD"
    ...
    async handleDeleteImg(index, imgIndex) {
      try {
        ...
        uni.removeSavedFile({
          ...
          success: () => {
            deleteFile(
              _this.pointList[index].fileList[imgIndex].id,
              () => {
