...
export default {
  ...
  methods: {
    ...
    async clickNode(node) {
      ...
      uni.navigateTo({
        url: `/menuConfigure/index?id=${appPanelId}&title=${instanceName}&isProcess=true&workflowDataId=${dataId}&instanceId=${instanceId}&processNodeId=${nodeId}&isFinish=1&isCcTom=1`,
