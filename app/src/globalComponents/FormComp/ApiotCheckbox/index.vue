<template>
  <view class="u-checkbox" :style="[checkboxStyle]">
    <view class="u-checkbox__icon-wrap" @tap="toggle" :style="[iconStyle]">
      <i
...
export default {
  ...
  computed: {
    ...
    iconStyle() {
      ...
      style.width = this.$apiot.addUnit(this.checkboxSize);
      style.height = this.$apiot.addUnit(this.checkboxSize);
      return style;
    },
    ...
    setValue() {
      ...
      if (this.value === true) {
        ...
        if (this.parent && checkedNum >= this.parent.max) {
          return this.$apiot.toast(`最多可选${this.parent.max}项`);
        }
