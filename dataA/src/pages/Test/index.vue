...
// const a = require('./100000_full.json');
...
export default {
  ...
  methods: {
    initChart() {
      const chartDom = document.getElementById('test1');
    ...
    //           40.189913
    //         ])[1],
    //         image: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fthumbimg.dealmoon.com%2Fdealmoon%2F9b0%2Fd47%2F2da%2Fde74feb328f5c1f4112eb2f.gif&refer=http%3A%2F%2Fthumbimg.dealmoon.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1661502354&t=553d8b4e73c669de72fbbbb94a7a358b'
    //       }
    //       // shape: {
    ...
    //         animation: false,
    //         silent: true,
    //         data: [{ name: '北京', value: [116.41989, 40.189913] }],
    //         z: -10
    //       }
    //     ]
    //   };
    ...
    //   let myChart = echarts.init(chartDom);
    //   myChart.showLoading();
    //   axios.get('/areas_v3/bound/geojson?code=632801', {
    //     headers: {
    ...
    //       }
    //       ],
    //       color: ['#eee', '#949fb1', '#f3ce85', '#322334']
    //     },
    //     // bmap: {
    //     //   center: [120.13066322374, 30.240018034923],
    //     //   zoom: 5,
