        ...
        dataList.forEach((item, index) => {
          ...
          if (type === 'line') {
            let obj = {
              ...
              itemStyle: {
                color: newColorArr[index].c1 || '#fff'
              },
              label: {
                show: true,
                align: 'center',
              ...
              obj.areaStyle = {
                ...
                color: {
                  ...
                  colorStops: [{
                    ...
                    offset: 1, color: newColorArr[index].c2 || newColorArr[params.dataIndex].c1 || '#fff' // 100% 处的颜色
                  }],
            ...
            obj = getChartMarkLineConfig({ baseConfig: obj, name, markLineConfig });
            series.push(obj);
          }
          if (type === 'bar') {
            let obj = {
