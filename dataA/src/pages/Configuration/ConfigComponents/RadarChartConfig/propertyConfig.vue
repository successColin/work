  ...
  <div class="bgContentWrap">
    <div class="propsSetting">
      ...
      <c-input
          ...
          @Input-Change="(value) => changeTitle(value, 'name')"/>
    </div>
    <location-properties
        ...
        <div>
          ...
          <div class="propsSetting">
            ...
            <c-input
                ...
                @Input-Change="(value) => changeStyles(value, 'splitNumber')"/>
          </div>
          <div class="propsSetting">
              ...
              <div>
                ...
                <div class="propsSetting">
                  ...
                  <c-input
                      type="number"
                      :min="0"
                      :numberValue="getComponentInfo.stylesObj.axisWidth"
                      @Input-Change="(value) => changeStyles(value, 'axisWidth')"/>
                </div>
                <div class="propsSetting">
              ...
              <div>
                ...
                <div class="propsSetting">
                  ...
                  <c-input
                      ...
                      @Input-Change="(value) => changeStyles(value, 'axisTickWidth')"/>
                </div>
                <div class="propsSetting">
                  ...
                  <c-input
                      ...
                      @Input-Change="(value) => changeStyles(value, 'axisTickLength')"/>
                </div>
                <div class="propsSetting">
            ...
            <el-collapse-item name="9">
              ...
              <div>
                ...
                <div class="propsSetting">
                  ...
                  <c-input
                      type="number"
                      :numberValue="getComponentInfo.stylesObj.axisLabelRotate"
                      @Input-Change="(value) => changeStyles(value, 'axisLabelRotate')"/>
                </div>
                <div class="propsSetting">
                  <p class="setTitle">标签偏移</p>
                  <c-input
                      type="number"
                      :numberValue="getComponentInfo.stylesObj.axisLabelMargin"
                      @Input-Change="(value) => changeStyles(value, 'axisLabelMargin')"/>
                </div>
              </div>
            </el-collapse-item>
              ...
              <div>
                <div class="propsSetting">
                  ...
                  <c-input
                      ...
                      @Input-Change="(value) => changeStyles(value, 'splitLineWidth')"/>
                </div>
                <div class="propsSetting">
          ...
          <div class="propsSetting">
            ...
            <div>
              <c-input
                  ...
                  @Input-Change="(value) => changeStyles(value, 'dataField')"
              />
            </div>
          </div>
          <el-tabs
                ...
                <div class="propsSetting">
                  ...
                  <div>
                    <c-input
                        type="number"
                        :min="0"
                        :numberValue="item.fieldValue"
                        @Input-Change="(value) => changeIndicator(value, 'fieldValue', i, 'indicator')"
                    ></c-input>
                  </div>
                </div>
                <div class="propsSetting">
                  ...
                  <div>
                    <c-input
                        type="text"
                        v-model="item.name"
                        @Input-Change="(value) => changeIndicator(value, 'name', i)"
                    ></c-input>
                  </div>
                </div>
                <div class="propsSetting">
                  ...
                  <div>
                    <c-input
                        type="number"
                        @Input-Change="(value) => changeIndicator(value, 'min', i, 'indicator')"
                ...
                <div class="propsSetting">
                  ...
                  <div>
                    <c-input
                        ...
                        @Input-Change="(value) => changeIndicator(value, 'max', i, 'indicator')"
                    />
                  </div>
                </div>
                <div class="propsSetting">
      ...
      <el-collapse-item name="3">
        ...
        <div>
          <div class="propsSetting">
            ...
            <c-input
                type="number"
                :numberValue="getComponentInfo.stylesObj.nameGap"
                @Input-Change="(value) => changeStyles(value, 'nameGap')"/>
          </div>
          <TextStylesConfig
              title="名称样式"
              title1="名称颜色"
                  ...
                  <el-collapse-item name="14">
                    ...
                    <div>
                      <TextStylesConfig
                          ...
                          @change="({value,key}) => changeIndicator(value, `axisLabel${key}`, i, 'customStyle')"
                      />
                      <div class="propsSetting">
                        <p class="setTitle">标签旋转角度</p>
                        <c-input
                            type="number"
                            :numberValue="item.axisLabelRotate"
                            @Input-Change="(value) => changeIndicator(value, 'axisLabelRotate', i, 'customStyle')"/>
                      </div>
                      <div class="propsSetting">
                        <p class="setTitle">标签偏移</p>
                        <c-input
                            type="number"
                            :numberValue="item.axisLabelMargin"
                            @Input-Change="(value) => changeIndicator(value, 'axisLabelMargin', i, 'customStyle')"/>
                      </div>
                    </div>
                  </el-collapse-item>
                  <el-collapse-item name="15">
                    ...
                    <div>
                      <div class="propsSetting">
                        ...
                        <c-input
                            type="number"
                            :numberValue="item.splitLineWidth"
                            @Input-Change="(value) => changeIndicator(value, 'splitLineWidth', i, 'customStyle')"/>
                      </div>
                      <div class="propsSetting">
                        ...
                        <div>
                          <c-select
                              ...
                              @change="(value) => changeIndicator(value, 'splitLineType', i, 'customStyle')"
                          ></c-select>
                        </div>
                      </div>
                      <div class="propsSetting">
                        ...
                        <div>
                          <c-color-picker
                              ...
                              show-alpha
                              @change="(value) => changeIndicator(value, 'axisColor', i, 'customStyle')"
                              :predefine="predefineColors">
                          </c-color-picker>
                        </div>
                      </div>
                      ...
                      <div class="bgSettingWrap">
                        ...
                        <div class="switchWrap">
                          <el-switch
                              ...
                              @change="(value) => changeIndicator(value, 'enableSplitArea', i, 'customStyle')"
                              active-color="#4689F5"
                              inactive-color="#183472">
                          </el-switch>
                        </div>
                      ...
                      <div class="propsSetting">
                        ...
                        <div>
                          <c-color-picker
                              ...
                              show-alpha
                              @change="(value) => changeIndicator(value, 'colorArr', i, 'customStyle')"
                              :predefine="predefineColors">
                          </c-color-picker>
                        </div>
                      </div>
                      ...
                      <div class="bgSettingWrap">
                        ...
                        <div class="switchWrap">
                          <el-switch
                              ...
                              @change="(value) => changeIndicator(value, 'enableHover', i, 'customStyle')"
                              active-color="#4689F5"
                              inactive-color="#183472">
                          </el-switch>
                        </div>
                    ...
                    <div v-if="item.enableHover">
                      <div class="ellipsisWrap flex propsSetting" style="margin-bottom: 0;">
                        ...
                        <el-switch
                            ...
                            @change="(value) => changeIndicator(value, 'enableLabel', i, 'customStyle')"
                            active-color="#4689F5"
                            inactive-color="#183472">
                        </el-switch>
                      </div>
                      <div class="propsSetting">
                        ...
                        <div>
                          <c-color-picker
                              ...
                              show-alpha
                              @change="(value) => changeIndicator(value, 'labelColor', i, 'customStyle')"
                              :predefine="predefineColors">
                          </c-color-picker>
                        </div>
                      </div>
                      <div class="propsSetting">
                        ...
                        <div>
                          <c-color-picker
                              ...
                              show-alpha
                              @change="(value) => changeIndicator(value, 'lineColor', i, 'customStyle')"
                              :predefine="predefineColors">
                          </c-color-picker>
                        </div>
                      </div>
                      <div class="propsSetting">
                        ...
                        <div>
                          <c-color-picker
                              ...
                              show-alpha
                              @change="(value) => changeIndicator(value, 'areaStyle', i, 'customStyle')"
                              :predefine="predefineColors">
                          </c-color-picker>
                        </div>
                      </div>
...
import {predefineColors, Line_TYPE} from '@/constants/global'
...
export default {
  ...
  methods: {
    addTab1(){
      ...
      let customStyle = info.customStyle || [];
