          ...
          <div class="bgSettingWrap">
            ...
            <div class="switchWrap">
              <el-switch
                  ...
                  @change="(value) => changeTitle(value ? 1:1, 'dataType')"
                  @click.stop.native
                  active-color="#4689F5"
        ...
        <div class="staticContent">
          ...
          <div class="propsSetting">
            ...
            <c-select
                ...
                :value="getComponentInfo.dataConfig.takeEffect"
                @change="(value) => changeStyles(value, 'takeEffect', 'dataConfig')">
            </c-select>
          </div>
        </div>
      </el-collapse-item>
      <el-collapse-item :name="2">
        ...
        <div class="apiContent">
          ...
          <div class="propsSetting">
            <p class="setTitle">选择字段</p>
            <c-select
                :options="fieldOptions(2)"
                :value="getComponentInfo.apiDataConfig.apiEffect"
                @change="(value) => changeStyles(value, 'apiEffect', 'apiDataConfig')">
            </c-select>
          </div>
          <div class="ellipsisWrap flex propsSetting">
      ...
      <el-collapse-item :name="3">
        ...
        <div class="apiContent">
          ...
          <div class="propsSetting">
            <p class="setTitle">选择字段</p>
            <c-select
                :options="fieldOptions(3)"
                :value="getComponentInfo.SqlDataConfig.SQLEffect"
                @change="(value) => changeStyles(value, 'SQLEffect', 'SqlDataConfig')">
            </c-select>
          </div>
          <div class="ellipsisWrap flex propsSetting">
            <span class="setTitle">是否自动更新</span>
  ...
  computed: {
    ...
    fieldOptions() {
      return function (type) {
        let jsonStr = '';
        if (type === 1) {
          jsonStr = this.getComponentInfo.dataConfig.staticValue;
        }
        if (type === 2) {
          jsonStr = this.getComponentInfo.apiDataConfig.apiFilterResponse || '{}';
        }
        if (type === 3) {
