        ...
        >
          <div>
            ...
            <div class="propsSetting">
              ...
              <c-input
                  type="number"
                  :numberValue="item.stylesObj.min"
                  @Input-Change="(value) => changeStyles(Number(value), 'min', i, item)"/>
            </div>
            <div class="propsSetting">
              <p class="setTitle">刻度最大值</p>
              <c-input
                  type="number"
                  :numberValue="item.stylesObj.max"
                  @Input-Change="(value) => changeStyles(Number(value), 'max', i, item)"/>
            </div>
            <div class="propsSetting">
              <p class="setTitle">刻度分割段数</p>
              <c-input
                  type="number"
                  :numberValue="item.stylesObj.splitNumber"
                  @Input-Change="(value) => changeStyles(Number(value), 'splitNumber', i, item)"/>
            </div>
            <el-collapse>
              <el-collapse-item name="5">
                ...
                <div>
                  ...
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.axisLineWidth"
                        @Input-Change="(value) => changeStyles(Number(value), 'axisLineWidth', i, item)"/>
                  </div>
                  <div class="propsSetting">
                    <p class="setTitle">轴线颜色</p>
                    <color-manage
                        :value="item.stylesObj.axisLineColorConfig"
                        @change="(value) => changeStyles(value, 'axisLineColorConfig', i, item)"></color-manage>
                  </div>
                </div>
              </el-collapse-item>
              <el-collapse-item name="6">
                ...
                <div>
                  ...
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.progressWidth"
                        @Input-Change="(value) => changeStyles(Number(value), 'progressWidth', i, item)"/>
                  </div>
                  <div class="propsSetting">
              ...
              <el-collapse-item name="7">
                ...
                <div>
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.splitLineLength"
                        @Input-Change="(value) => changeStyles(Number(value), 'splitLineLength', i, item)"/>
                  </div>
                  <div class="propsSetting">
                    <p class="setTitle">离轴线的距离</p>
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.splitLineDistance"
                        @Input-Change="(value) => changeStyles(Number(value), 'splitLineDistance', i, item)"/>
                  </div>
                  <div class="propsSetting">
                  ...
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.splitLineWidth"
                        @Input-Change="(value) => changeStyles(Number(value), 'splitLineWidth', i, item)"/>
                  </div>
                  <div class="propsSetting">
              ...
              <el-collapse-item name="8">
                ...
                <div>
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.axisTickSplitNumber"
                        @Input-Change="(value) => changeStyles(Number(value), 'axisTickSplitNumber', i, item)"/>
                  </div>
                  <div class="propsSetting">
                    <p class="setTitle">刻度线长</p>
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.axisTickLength"
                        @Input-Change="(value) => changeStyles(Number(value), 'axisTickLength', i, item)"/>
                  </div>
                  <div class="propsSetting">
                    <p class="setTitle">刻度线与轴线的距离</p>
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.axisTickDistance"
                        @Input-Change="(value) => changeStyles(Number(value), 'axisTickDistance', i, item)"/>
                  </div>
                  <div class="propsSetting">
                  ...
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.axisTickWidth"
                        @Input-Change="(value) => changeStyles(Number(value), 'axisTickWidth', i, item)"/>
                  </div>
                  <div class="propsSetting">
              ...
              <el-collapse-item name="9">
                ...
                <div>
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.axisLabelDistance"
                        @Input-Change="(value) => changeStyles(Number(value), 'axisLabelDistance', i, item)"/>
                  </div>
                  <TextStylesConfig
                      title="标签字体样式"
                      title1="标签字体颜色"
              ...
              <el-collapse-item name="10">
                ...
                <div>
                  ...
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.pointerLength"
                        :min="0"
                        :max="100"
                        @Input-Change="(value) => changeStyles(Number(value), 'pointerLength', i, item)"/>
                  </div>
                  <div class="propsSetting">
                    <p class="setTitle">指针宽度</p>
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.pointerWidth"
                        @Input-Change="(value) => changeStyles(Number(value), 'pointerWidth', i, item)"/>
                  </div>
                  <div class="propsSetting">
              ...
              <el-collapse-item name="11">
                ...
                <div>
                  ...
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="number"
                        :numberValue="item.stylesObj.anchorSize"
                        :min="0"
                        :max="100"
                        @Input-Change="(value) => changeStyles(Number(value), 'anchorSize',i, item)"/>
                  </div>
                  <div class="propsSetting">
              ...
              <el-collapse-item name="12">
                ...
                <div>
                  <div class="propsSetting">
                    ...
                    <c-input
                        type="text"
                        v-model="item.stylesObj.valueMappingField"
...
export default {
  ...
  methods: {
    ...
    changeStyles(val, key, i, obj) {
      ...
      console.log(33333333, key, newObj)
      this.$emit('change', this.config);
    },
