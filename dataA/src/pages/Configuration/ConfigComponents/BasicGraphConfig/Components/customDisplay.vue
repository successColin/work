...
<template>
  <div>
    ...
    >
      ...
      <div class="propsSetting">
        <p class="setTitle">节点大小</p>
        <c-input
            type="number"
            :numberValue="configItem.symbolSize"
            @Input-Change="(value) => change(value, 'symbolSize', i, configItem)"/>
      </div>
      <div class="propsSetting">
        <p class="setTitle">节点填充色</p>
              <c-color-picker
                  style="margin-right: 10px;"
                  size="small"
                  v-model="configItem.nodeColor"
                  show-alpha
                  @change="(value) => change(value, 'nodeColor', i, configItem)"
