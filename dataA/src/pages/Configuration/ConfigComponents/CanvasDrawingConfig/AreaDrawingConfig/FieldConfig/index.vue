...
<template>
  <div class="fieldWrap">
    <div class="addWrap">
      <c-button icon="icon-xinzeng iconfont" @click="visible=true">新增字段</c-button>
    </div>
        ...
        <div class="formWrap">
          <div class="rowWrap">
            ...
            <div class="col-12">
              ...
              <CDataSelectionBox
                  style="width: 170px;"
                  @handleSelect="(obj) =>this.handleSelect(obj.name, 'businessField', obj.memo,'businessFieldName')"
                  class="formItem"
          ...
          <div class="rowWrap">
            ...
            <div class="col-12">
              ...
              <CDataSelectionBox
                  style="width: 170px;"
                  @handleSelect="(obj) =>this.handleSelect(obj.name, 'entitySort')"
                  class="formItem"
                  :otherParams="{tableName: fieldConfig.businessTable}"
                  :value="{name:fieldConfig.entitySort }"
                  type="filedName"
              ></CDataSelectionBox>
            </div>
        ...
        <div class="varManage" v-if="!!fieldConfig.isMultiLevelEntity">
          ...
          <div class="dataListContent">
            ...
            <div class="listBoxWrap">
              <div class="listWrap" v-for="(item, i) in fieldConfig.multiLevelEntityConfig" :key="i">
