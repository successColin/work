  ...
  <div class="bgContentWrap">
    ...
    <div class="propsSetting" style="margin-bottom: 30px;">
      ...
      <div class="wrap">
        ...
        >
          <template v-slot:tip>
            <div class="el-upload__tip">只能上传png,jpg,jpeg图片，且不超过2MB</div>
          </template>
        </c-upload>
      </div>
    </div>
    <div class="propsSetting">
      ...
      <c-input
          ...
          :precision="0"
          type="number"
          :numberValue="getComponentInfo.stylesObj.opacity * 100"
          @Input-Change="(value) => changeStyles((Number(value)/100), 'opacity')"/>
    </div>
    <div class="propsSetting">
      ...
      <div class="rotateWrap">
        <c-input
            type="number"
            :precision="0"
            :numberValue="getComponentInfo.stylesObj.rotationAngle"
            @Input-Change="(value) => changeStyles((Number(value)), 'rotationAngle')"/>
        <div
            class="box flex"
