          ...
          <div class="propsSetting">
            ...
            <div>
              <c-input
                  ...
                  @Input-Change="(value) => changeStyles(Number(value), 'barWidth')"/>
            </div>
          </div>
          <div class="propsSetting">
          ...
          <div class="propsSetting">
            ...
            <div>
              <c-input
                  type="number"
                  :min="0"
                  :numberValue="getComponentInfo.stylesObj.labelOffset"
                  @Input-Change="(value) => changeStyles(value, 'labelOffset')"/>
            </div>
          </div>
