            ...
            <div class="paramsSettingWrap">
              ...
              <div>
                <c-input
                    ...
                    @Input-Change="(value) => changeStyles(value, 'timeTypeFiled')"
                />
              </div>
            </div>
            <div class="paramsSettingWrap" style="margin-top: 10px;">
              ...
              <div>
                <c-input
                    ...
                    placeholder="输入参数字段"
                    @Input-Change="(value) => changeStyles(value, 'timeValueFiled')"
                />
              </div>
            </div>
          </div>
          ...
          <div class="propsSetting">
            ...
            <div>
              <el-checkbox-group
                  ...
                  class="checkboxWrap">
                <el-checkbox v-for="times in getTimeTypeOthers" :label="times.value" :key="times.value">
                  {{ times.label }}
                </el-checkbox>
              </el-checkbox-group>
            </div>
