    ...
    <el-collapse v-model="activeName" accordion>
      <el-collapse-item name="1" title="图形属性">
        <div>
          ...
          <!--            <span class="setTitle">分组间距</span>-->
          <!--            <el-switch-->
          <!--                :value="getComponentInfo.dataConfig.enableApiFilter"-->
          <!--                @change="(value) => changeStyles(value, 'enableApiFilter')"-->
          <!--                active-color="#4689F5"-->
          <!--                inactive-color="#183472">-->
          <!--            </el-switch>-->
          <!--          </div>-->
          ...
          <div class="ellipsisWrap propsSetting">
            <span class="setTitle">自定义柱颜色</span>
            <data-color
          ...
          <!--            <p class="setTitle">布局</p>-->
          <!--            <div>-->
          <!--              <c-select-->
          <!--                  :options="layOutOptions"-->
          <!--                  :value="getComponentInfo.stylesObj.legendOrient"-->
          <!--                  @change="(value) => changeStyles(value, 'legendOrient')"-->
          <!--              ></c-select>-->
          <!--            </div>-->
          <!--          </div>-->
        </div>
      ...
      <el-collapse-item title="标记及标线设置" name="7">
        <MarkConfig
