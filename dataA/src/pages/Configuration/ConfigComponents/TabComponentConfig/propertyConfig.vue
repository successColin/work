  ...
  <div class="bgContentWrap">
    ...
    <el-collapse v-model="activeName" accordion>
      <el-collapse-item name="2" title="样式设置">
        <div>
          ...
          <div class="propsSetting">
            ...
            <div>
              <c-input
                  :numberValue="getComponentInfo.stylesObj.tabMarginLeftAndRight"
                  type="number"
                  @Input-Change="(value) => changeStyles(Number(value), 'tabMarginLeftAndRight')"
              />
            </div>
          </div>
      ...
      <el-collapse-item title="交互设置" name="4">
        <div>
          <div class="addWrap">
            <c-button type="primary" icon="icon-xinzeng iconfont" @click="handleAdd">新增Tab</c-button>
          </div>
              ...
              <div class="propsSetting">
                <div>
                  <c-input
                      ...
                      @Input-Change="(value) => changeTabConfig(value, 'name', item, index)"
                  />
                </div>
              </div>
              <div class="propsSetting">
                ...
                <div class="propsSetting flexItem">
                  ...
                  <div>
                    <c-upload
                        ...
                        @changeScreenBg="(value) => changeTabConfig(value, 'unActiveIcon', item, index)"
                        accept=".png,.jpg,.jpeg,.svg"
                    >
                    </c-upload>
                  </div>
        ...
        <div>
          <div class="propsSetting">
            ...
            <c-input
                ...
                @Input-Change="(value) => changeStyles(value, 'paramName')"
            />
          </div>
...
export default {
  ...
  methods: {
    handleDel(index) {
      ...
      let tabConfigArr = [...info.tabConfig] || [];
