    ...
    <el-collapse v-model="activeName" accordion>
      <el-collapse-item title="文本样式" name="1">
        <div>
          ...
          <div class="propsSetting">
            <p class="setTitle">文字滚动速度</p>
            <c-input
                type="number"
                :min="0.1"
                :max="1"
                :numberValue="getComponentInfo.stylesObj.speed"
                :step="0.1"
                @Input-Change="(value) => changeStyles(Number(value), 'speed')"/>
          </div>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item title="其他配置" name="3">
        <div>
          <div class="propsSetting">
            <p class="setTitle">回调变量</p>
            <c-input
                type="text"
                :value="getComponentInfo.param"
                @Input-Change="(value) => changeTitle(value, 'param')"
                @blur="(e) => checkIsRight(e.target.value, 'param')"
            />
          </div>
          <div class="propsSetting">
            <p class="setTitle">回调字段</p>
            <c-input
                type="text"
                :value="getComponentInfo.field"
                @Input-Change="(value) => changeTitle(value, 'field')"
                @blur="(e) => checkIsRight(e.target.value, 'field')"
            />
          </div>
          <div class="propsSetting">
