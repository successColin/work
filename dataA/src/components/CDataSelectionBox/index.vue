...
<template>
  <div class="CDataSelectionBox">
    ...
    <div class="dataAdd" @click="visible=true">
      <span class="icon-tianjiatupian iconfont"></span>
    </div>
    <CDialog
      ...
      <div class="tableWrap" v-loading="loading">
        ...
        <div class="footerWrap">
          ...
          <div class="btnWrap">
            ...
            <c-button type="primary" @click="handleOk">确定</c-button>
          </div>
        </div>
      </div>
    </CDialog>
...
<script>
import {getTableList, getObvious, getFiledsByPage} from '@/services/design';
...
.CDataSelectionBox {
  ...
  &:hover .dataInner {
    ...
    border-left: 1px solid #6CA3FD;
    border-top: 1px solid #6CA3FD;
  }

  &:hover .dataAdd {
    border: 1px solid #6CA3FD;
  }
