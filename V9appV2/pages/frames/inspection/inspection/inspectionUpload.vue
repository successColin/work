      ...
      >
        ...
        <view class="result-detail">
          ...
          <view class="result-detail-item">
            ...
            ><!--中文消耗工时-->
            <text :style="manhoursStyle(item.manhours)">
							{{ item.manhours ? item.manhours + $t('time-minutes') : 0 + $t('time-minutes') }}
						</text><!--中文：分-->
          </view>
        </view>
      ...
      inspectionApi
        ...
        .then(function (res) {
          ...
          if (that.upInspData.length - 1 !== num) {
			...
			updateManhourSql('inspectiondo', that.inspectionId)
          }
        })
        .catch(function (err) {
          uni.hideLoading();
