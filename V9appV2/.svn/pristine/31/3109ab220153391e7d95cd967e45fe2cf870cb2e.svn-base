      ...
      <view class="uni-calendar__wrapper">
        <view class="uni-calenda__content">
          ...
          <view class="calendar-header">
            <view class="item">{{ $t('time-week-sun') }}</view>
            <!-- 中文：日 -->
            <view class="item">{{ $t('time-week-mon') }}</view>
            <!-- 中文：一 -->
            <view class="item">{{ $t('time-week-tue') }}</view>
            <!-- 中文：二 -->
            <view class="item">{{ $t('time-week-wed') }}</view>
            <!-- 中文：三 -->
            <view class="item">{{ $t('time-week-thu') }}</view>
            <!-- 中文：四 -->
            <view class="item">{{ $t('time-week-fri') }}</view>
            <!-- 中文：五 -->
            <view class="item">{{ $t('time-week-sat') }}</view>
            <!-- 中文：六 -->
          </view>
          <uni-calendar-item
