const state = {
  ...
  passwordValidity: '0', // 0永久;30天;90天;180天;365天
  PasswordLevel: '1', //密码强度
  platform: 'APP', //平台
  appName: 'APIoT', //平台名称
  ...
  frameType: '', //框架类型
  userInfo: {},
  shareBaseUrl: 'https://v9.mingcloud.top/eam/',
  singleLogin: false,
  // #ifdef H5
  defaultUrl: '/eam/', //默认url
  // #endif
  // #ifndef H5
  defaultUrl: 'http://47.97.155.39/eam/',
  // defaultUrl: 'http://192.168.0.23:8080/eam/',
  // #endif
  appLoginLogo: '', //登录logo
  technicalSupport: 'APIoT',
  scanningType: '',
  messageNum: 0, // 消息推送条数
  unDoInspectionDo: 0, // 是否处理未完成点检任务
  readCardType: 'NFC', // 读卡类型：nfc或者rfid
  hourFillingAutomatic: '1', // 自动填写巡检工时，1=⼿动；2=⾃动
  QRType: 0,
};
