...
export default {
  ...
  FETCH_NODE_MODULES: '/system/role/listDefaultSysRoleAuthorityModule', // 获取app和pc的模块的
  ...
  ADD_HOT_DESIGN_CANVAS: '/hostPotController/insetHostPot', // 新增热区
  GET_HOT_DESIGN_INFO: '/hostPotController/getSysHostPotById', // 获取热区详情
  EDIT_HOT_DESIGN_INFO: '/hostPotController/modifyHosPot', // 编辑热区详情
  DEL_HOT_DESIGN: '/hostPotController/deleteHostPot', // 删除热区
  BATCH_DESIGN_FOR_LIST: '/hostPotController/batchModifyHosPot', // 批量修改热区
  GET_ZOOM_LIST_BY_PAGE: '/hostPotController/pageHostPot', // 获取热区图层列表
  GET_TABLE_FIELDS_OBVIOUS: '/hostPotController/pageColumnsTable', // 获取数据详情
  GET_DESIGN_INFO_BY_ELEMENT: '/hostPotController/getHostPotData', // 获取控件热区
  COPY_DESIGN_ELEMENT: '/hostPotController/copyElement', // 复制控件
  ...
  // 代理
  DO_GET_INIT_TREE: '/api/getTree', // 初始化树
  DO_ADD_TREE_GROUP: '/api/addGroup', // 新增分组
  DO_DEL_TREE_GROUP: '/api/deleteGroup', // 删除树分组
  GET_API_DETAILS: '/api/getApiProxy', // 获取接口详情
  DO_SAVE_API: '/api/addApiProxy', // 新增修改接口配置
  DO_SEND_BY_TEMPLATE: '/trigger/mockRequest', // 模拟请求
  DO_CREATE_MESSAGE: '/trigger/getRequestBody', // 生产请求报文
  DO_GET_API_LOG: '/api/getApiLog', // 获取调用记录
  DO_DEL_API_CONFIG: '/api/deleteApiProxy', // 删除接口配置
  // 专家
  DO_GET_EXPERT_LIST: '/remoteassistance/expert/page', // 专家列表
  DO_ADD_EXPERT: '/remoteassistance/expert/insert', // 新增专家
  DO_EDIT_EXPERT: '/remoteassistance/expert/update', // 编辑专家
  DO_DEL_EXPERT: '/remoteassistance/expert/delete', // 删除专家
  // 眼镜
  DO_GET_GLASSES_LIST: '/remoteassistance/glasses/page', // 眼镜列表
  DO_ADD_GLASSES: '/remoteassistance/glasses/insert', // 新增眼镜
  DO_EDIT_GLASSES: '/remoteassistance/glasses/update', // 眼镜更新
  DO_DEL_GLASSES: '/remoteassistance/glasses/delete', // 刪除眼鏡
  // 远程终端
  DO_GET_GLASSES_MEETING: '/remoteassistance/glasses/findGlassesMeeting', // 远程终端列表
  DO_GET_USER_SIG: '/remoteassistance/genUserSig', // 获取远程协助sdk用户签名
  DO_GET_USER_BY_ID: '/system/user/getSysUser', // 根据id获取用户详情
  DO_SET_CONFERENCE: '/remoteassistance/acceptConference', // 生成会议id
  DO_UPDATE_CONFERENCE: '/remoteassistance/finishConference/', // 结束会议
  DO_PC_MEETING: '/remoteassistance/sponsorConference', // pc端发起会议
  DO_GET_HISTORY: '/remoteassistance/getConferenceHistory', // pc端获取会议历史
  DO_DEL_HISTORY: '/remoteassistance/deleteConferenceHistory', // 删除会议
  SET_EXPERT_OFFLINE: '/remoteassistance/expert/offline', // 专家下线
};
