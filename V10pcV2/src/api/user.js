...
export function fetchModules(params) {
  return fetch.request({
    url: query.FETCH_NODE_MODULES,
    params,
  });
}

// 获取用户配置
export function getDesignPage(params) {
  return fetch.request({
    url: '/system/userPage/getDesignPage',
    method: 'get',
    params,
  });
}
...
// 保存用户配置
export function modifyDesignPage(data) {
  return fetch.request({
    url: '/system/userPage/modifyDesignPage',
    method: 'post',
    data,
  });
}
...
export function getUserDetails(params) {
  return fetch.request({
    url: '/system/userPage/getUserDetails',
    method: 'get',
    params,
  });
}
