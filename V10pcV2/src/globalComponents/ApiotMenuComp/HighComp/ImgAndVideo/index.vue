    ...
    >
      ...
      >
        <div class="upload__btnBox">
          ...
          <p>{{ isPreview ? '预览模式不支持上传' : configData.placeholder }}</p>
        </div>
      ...
      >
        <div class="el-upload__text">
          ...
          {{ isPreview ? '预览模式不支持上传' : configData.adviseTip }}
        </div>
        <div
          slot="file"
          slot-scope="{ file }"
    ...
    beforeUpload(file) {
      return new Promise((resolve, reject) => {
        ...
        if (
          ...
          this.fileList.length >= this.configData.maxFileCount
        ) {
          this.$message({
            type: 'warning',
