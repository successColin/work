  ...
  >
    ...
    >
      <div
        ...
        ref="menuMainCard"
        :class="[{ active: isPreview ? true : isItemActive(item) }]"
        v-for="(item, index) in getCardData"
      ...
      >
        ...
        >
          <!-- 预览区域 -->
          <div class="menuMain__feature--compList" v-if="isPreview">
            <component
  ...
  methods: {
    ...
    getFilterParams() {
      ...
      if (
        ...
        console.log(+this.$route.query.isJump === 1);
