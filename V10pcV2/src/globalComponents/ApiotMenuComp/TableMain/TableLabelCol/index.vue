  ...
  computed: {
      ...
      return (data) => {
        ...
        if (content !== '') {
          if (+this.configData.dataSource.columnTypeDict === 3) {
            ...
            if (this.configData.timeShowType === 4 && content) {
              content = content.toString().slice(0, 4);
            }
            if (this.configData.timeShowType === 5 && content) {
              content = content.toString().slice(0, 7);
            }
          }
          if (+this.configData.dataSource.columnTypeDict === 1) {
            ...
            if (this.configData.numberShowType === 3 && content) {
    ...
    getStyle() {
      ...
      if (this.configData.font) {
        if (
          this.configData.font.color &&
          this.configData.font.color !== '#333333'
        ) {
    ...
    showMenuColor() {
      ...
      if (!curMenuArr || curMenuArr.length === 0) {
        return false;
      }
      return true;
    },
  ...
  methods: {
    ...
    labelClick(rowData) {
      ...
      if (!relateType || relateType === 1) {
        ...
        window.open(
          this.configData.outerLink || this.getContentArr(rowData)[0],
        );
      }
    },
    jumpMenu() {
