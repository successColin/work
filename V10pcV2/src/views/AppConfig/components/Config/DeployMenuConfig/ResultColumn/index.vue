  ...
  >
    ...
    <section class="task__list">
      <div class="task__head task__item">
        ...
        <span class="task__item--value">值</span>
        <span class="task__item--columnName">字段别名</span>
        <span class="task__item--taskColor">颜色</span>
          ...
          >
            ...
            >
              ...
              <span class="task__item--title"
                ><apiot-input v-model="item.title"></apiot-input
              ></span>
              <span class="task__item--value">
                <apiot-input v-model="item.value"></apiot-input>
              </span>
              <span class="task__item--columnName">
                <apiot-input v-model="item.columnName"></apiot-input>
              </span>
              <span class="task__item--taskColor">
                <apiot-color-picker
                  class="taskColor"
                  v-model="item.taskColor"
  ...
  watch: {
    showColumnDialog(v) {
      if (!v) {
        ...
        this.$emit('update:columnArrBack', this.columnArr);
      } else {
        this.columnArr = this.columnArrBack;
      }
    },
  },
};
