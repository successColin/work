  ...
  <div class="bgContentWrap">
    ...
    <div class="propsSetting">
      <el-radio-group
        ...
        size="mini"
      >
        <el-radio label="bgColor"> 颜色填充 </el-radio>
        <el-radio label="bgImage"> 上传图片 </el-radio>
      </el-radio-group>
    </div>
    ...
    <div class="propsSetting" v-if="getComponentInfo.bgType === 'bgImage'">
      ...
      <div class="rotateWrap">
        ...
        <div
          ...
          @click="
            changeTitle(!getComponentInfo.horizontalMirror, 'horizontalMirror')
          "
        >
          <div class="left"></div>
          <div class="right"></div>
        ...
        <div
          class="box"
          @click="
            changeTitle(!getComponentInfo.verticalMirror, 'verticalMirror')
          "
