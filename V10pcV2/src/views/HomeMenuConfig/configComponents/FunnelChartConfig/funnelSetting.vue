          ...
          <div>
            ...
            <div class="propsSetting">
              ...
              <div>
                <c-select
                  ...
                  @change="
                    (value) => changeStyles(value, 'funnelAlign', i, item)
                  "
                >
                </c-select>
              </div>
            ...
            <div class="propsSetting flex around">
              ...
              <el-switch
                ...
                @change="
                  (value) => changeStyles(value, 'isShowTooltip', i, item)
                "
                active-color="#4689F5"
            ...
            <TextStylesConfig
              ...
              @change="
                ({ value, key }) => changeStyles(value, `label${key}`, i, item)
              "
            />
            <div class="propsSetting" v-if="item.isShowLabel">
              ...
              <div>
                <c-select
                  ...
                  @change="
                    (value) => changeStyles(value, 'labelPosition', i, item)
                  "
                >
                </c-select>
              </div>
            ...
            <div class="propsSetting">
              ...
              <div>
                <c-color-picker
                  ...
                  show-alpha
                  @change="
                    (value) => changeStyles(value, 'itemBorderColor', i, item)
                  "
            ...
            <div class="propsSetting">
              ...
              <el-input-number
                ...
                @change="
                  (value) => changeStyles(value, 'itemBorderWidth', i, item)
                "
              />
            </div>
            <div class="propsSetting">
              ...
              <div>
                <c-select
                  ...
                  @change="
                    (value) => changeStyles(value, 'itemBorderType', i, item)
                  "
                >
                </c-select>
              </div>
            ...
            <div class="propsSetting">
              ...
              <el-input-number
                ...
                @change="
                  (value) => changeStyles(value, 'itemShadowBlur', i, item)
                "
              />
            </div>
            <div class="propsSetting">
              ...
              <div>
                <c-color-picker
                  ...
                  show-alpha
                  @change="
                    (value) => changeStyles(value, 'itemShadowColor', i, item)
                  "
                  :predefine="predefineColors"
                >
                </c-color-picker>
            ...
            <div class="propsSetting">
              ...
              <el-input-number
                ...
                @change="
                  (value) => changeStyles(value, 'itemShadowOffsetX', i, item)
                "
              />
            </div>
            <div class="propsSetting">
              ...
              <el-input-number
                ...
                @change="
                  (value) => changeStyles(value, 'itemShadowOffsetY', i, item)
                "
              />
            </div>
            <div class="propsSetting">
