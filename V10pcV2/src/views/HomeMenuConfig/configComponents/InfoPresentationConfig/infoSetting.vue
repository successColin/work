          ...
          <div>
            ...
            <div class="propsSetting">
              ...
              <div>
                <apiot-input
                    :maxlength="16"
                    :value="item.field"
                    @input="(value) => changeStyles(value, 'field', i, item)"/>
              </div>
            </div>
            <div class="propsSetting">
              ...
              <div>
                <apiot-input
                    ...
                    @input="(value) => changeStyles(value, 'labelName', i, item)"/>
              </div>
            </div>
              ...
              <div class="propsSetting">
                ...
                <div>
                  <apiot-input
                      ...
                      @input="(value) => changeStyles(value, 'labelDefaultName', i, item)"/>
                </div>
              </div>
              <TextStylesConfig
                  title="标签样式"
              ...
              <div v-if="item.isNeedBg && !item.isEdit">
                ...
                <div class="propsSetting">
                  ...
                  <el-input-number
                      ...
                      @change="(value) => changeStyles(Number(value), 'borderRadius', i, item)"/>
                </div>
            ...
            <div class="propsSetting" v-if="item.isApplyToPictures">
              ...
              <el-input-number
                  ...
                  controls-position="right"
                  :value="item.imgWidth"
                  @change="(value) => changeStyles(Number(value), 'imgWidth', i, item)"/>
            </div>
            <div class="propsSetting" v-if="item.isApplyToPictures">
              ...
              <el-input-number
                  ...
                  @change="(value) => changeStyles(Number(value), 'imgHeight', i, item)"/>
            </div>
            <!-- 输入框编辑配置 -->
            <div v-if="item.isEdit">
              <div class="propsSetting">
                ...
                <el-input-number
                    ...
                    controls-position="right"
                    :value="item.editRows"
                    @change="(value) => changeStyles(Number(value), 'editRows', i, item)"/>
              </div>
              <div class="propsSetting">
              ...
              <div class="propsSetting">
                ...
                <el-input-number
                    ...
                    :min="0"
                    controls-position="right"
                    :value="item.editBorderRadius"
                    @change="(value) => changeStyles(Number(value), 'editBorderRadius', i, item)"/>
              </div>
              <div class="propsSetting">
                <p class="setTitle">背景颜色</p>
                <div>
