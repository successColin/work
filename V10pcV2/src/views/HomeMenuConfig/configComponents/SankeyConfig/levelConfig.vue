              ...
              <div class="propsSetting">
                ...
                <div>
                  <el-input-number
                      ...
                      @change="(value) => changeStyles(value, 'distance', i, item)"
                  />
                </div>
              </div>
              <div class="propsSetting">
                ...
                <div>
                  <el-input-number
                      ...
                      controls-position="right"
                      v-model="item.rotate"
                      @change="(value) => changeStyles(value, 'rotate', i, item)"
                  />
                </div>
              </div>
            ...
            <div class="propsSetting">
              ...
              <div>
                <el-input-number
                    ...
                    :max="1"
                    controls-position="right"
                    v-model="item.lineStyleOpacity"
                    @change="(value) => changeStyles(value, 'lineStyleOpacity', i, item)"
                />
              </div>
            </div>
            <div class="propsSetting">
              ...
              <div>
                <el-input-number
                    ...
                    :max="1"
                    controls-position="right"
                    v-model="item.curveness"
                    @change="(value) => changeStyles(value, 'curveness', i, item)"
                />
              </div>
            </div>
          </div>
