...
<template>
  <div class="varManage">
    <div>
      <apiot-button type="primary" @click="add"><i class="el-icon-edit"></i> 新增</apiot-button>
    </div>
    <div class="dataListContent">
      <div class="thead">
        <div style="width: 40px;">序号</div>
        <div style="width: 35%;">字段</div>
      ...
      <div class="listWrap" v-for="(item, i) in tableData" :key="i">
        ...
        <div class="inner">
          <apiot-input v-model="item.name" ref="input" @blur="(v) => check(v.target.value, i)"/>
        </div>
        <div class="inner">
