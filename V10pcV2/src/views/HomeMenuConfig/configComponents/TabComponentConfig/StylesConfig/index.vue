  ...
  <div>
    ...
    <div class="numberWrap">
      <div class="propsSetting flexItem">
        ...
        <el-input-number
          ...
          v-model="stylesObj.cPaddingTopAndBottom"
          @change="
            (value) => changeStyles(Number(value), 'cPaddingTopAndBottom')
          "
        />
      </div>
      <div class="propsSetting flexItem">
        ...
        <el-input-number
          controls-position="right"
          v-model="stylesObj.cPaddingRightAndLeft"
          @change="
            (value) => changeStyles(Number(value), 'cPaddingRightAndLeft')
          "
        />
      </div>
    </div>
    <div class="numberWrap">
      <div class="propsSetting flexItem">
        ...
        <c-color-picker
          ...
          @change="(value) => changeStyles(value || '#fff', 'cColor')"
          :predefine="predefineColors"
        >
        </c-color-picker>
      </div>
      <div class="propsSetting flexItem" v-if="type === 'unActiveConfig'">
        ...
        <c-color-picker
          ...
          @change="(value) => changeStyles(value || '#fff', 'cHoverColor')"
          :predefine="predefineColors"
        >
        </c-color-picker>
      </div>
    </div>
    <div class="numberWrap" v-if="stylesType === 'styleThree'">
      <div class="propsSetting flexItem">
        ...
        >
          <!--          <template v-slot:tip>-->
          <!--            <div class="el-upload__tip">只能上传png,jpg,jpeg图片，且不超过50kb</div>-->
          <!--          </template>-->
        </c-upload>
      </div>
      <div class="propsSetting flexItem">
    ...
    <div class="numberWrap" v-if="stylesType === 'styleThree'">
      <div class="propsSetting flexItem">
        ...
        <c-color-picker
          ...
          @change="(value) => changeStyles(value || '#fff', 'cBgColor')"
          :predefine="predefineColors"
        >
        </c-color-picker>
      </div>
      <div class="propsSetting flexItem">
        ...
        <div>
          <c-color-picker
            ...
            @change="(value) => changeStyles(value || '#fff', 'cHoverBgColor')"
            :predefine="predefineColors"
          >
          </c-color-picker>
        </div>
    ...
    <div class="numberWrap" v-if="stylesType === 'styleThree'">
      <div class="propsSetting flexItem">
        ...
        <el-input-number
          controls-position="right"
          v-model="stylesObj.borderWidth"
          @change="(value) => changeStyles(Number(value), 'borderWidth')"
        />
      </div>
      <div class="propsSetting flexItem">
        ...
        <el-input-number
          controls-position="right"
          v-model="stylesObj.borderRadius"
          @change="(value) => changeStyles(Number(value), 'borderRadius')"
        />
      </div>
    </div>
    <div class="propsSetting" v-if="stylesType === 'styleThree'">
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (!isLt2M) {
          this.$message.warning('上传头像图片大小不能超过 50kb!');
          reject(file);
          return false;
        }
        return resolve(file);
