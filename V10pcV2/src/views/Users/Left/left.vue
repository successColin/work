...
export default {
  ...
  computed: {
    getDefaultLeftTypeName() {
      return function () {
        return this.defaultLeftTypeName || this.$t('user.roles');
      };
    },
    getInputPlaceholder() {
      return function () {
        return this.inputPlaceholder || this.$t('user.placeholder_role');
      };
    },
  },
  created() {
    console.log(this.fatherDefaultType);
    this.handleCommand(this.fatherDefaultType);
  },
  mounted() {
    this.loading = false;
  },
