  ...
  <div class="printContent" ref="content">
    <div
      ...
      :style="`
          ...
          height: calc(${printParams.areaHeight} - 1px);
          position: relative;
          overflow: hidden;
    ...
    >
      ...
      <img
        ...
        :style="`
          padding-top: ${globalConfig.marginTop}mm;
          padding-left: ${globalConfig.marginLeft}mm;
          position: absolute;
          width: ${val.crop.width}px;
          height: ${val.crop.height}px;
          top: calc(${val.default.top}px;
...
export default {
  ...
  watch: {},
  mounted() {
    if (this.$parent.getContentBottomHeight && this.$refs.pageRowBottomRef) {
  ...
  methods: {
    ...
    getCellWidthArr(v) {
      v.forEach((item) => {
        this.cellWidthArr.push(item.offsetWidth);
      });
    },
