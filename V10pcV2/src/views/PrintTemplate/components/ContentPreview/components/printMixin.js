export default {
  ...
  computed: {
    type() {
      return this.printParams.globalConfig.type || 1;
    },
    everyWidth() {
    ...
    mergeObj() {
      return (
        (this.printParams.previewObj.config &&
          this.printParams.previewObj.config.merge) ||
        {}
      );
    },
    contentWidth() {
