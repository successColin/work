<template>
  <section class="formula">
    <div class="formula__params">
      <div class="formula__params--comp" v-if="!showFormulaComp">
        <div class="formula__params--compHead">
          <el-dropdown class="formula__treeSelect" @command="treeSelect">
            ...
            <el-dropdown-menu slot="dropdown" class="formula__treeSelect--list">
              <el-dropdown-item :command="1">表单控件</el-dropdown-item>
              <el-dropdown-item :command="2">函数</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
      ...
      <div class="formula__params--comp" v-if="showFormulaComp">
        <div class="formula__params--compHead">
          <el-dropdown class="formula__treeSelect" @command="treeSelect">
            ...
            <el-dropdown-menu slot="dropdown" class="formula__treeSelect--list">
              <el-dropdown-item :command="1" v-if="treeType !== 5"
                >表单控件</el-dropdown-item
              >
              <el-dropdown-item :command="2">函数</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
