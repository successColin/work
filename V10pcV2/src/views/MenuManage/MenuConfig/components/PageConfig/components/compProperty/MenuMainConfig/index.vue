<template>
  <div class="contentConfig">
    ...
    <section class="contentConfig__wrapper" v-if="!isBtnArea">
      ...
      <div class="contentConfig__box contentConfig__areaShow" v-if="!isUser">
        <h2>区域展示</h2>
      ...
      <div class="contentConfig__box contentConfig__dataSource" v-if="!isUser">
        <h2>布局样式</h2>
        <el-select
          placeholder="请选择布局样式"
      ...
      >
        ...
        <apiot-button
          class="contentConfig__dataSource--addRelate"
          v-if="getCurrentTab && getCurrentTab.tableInfo.tableName && !isUser"
          @click="
            currentRadioObj = null;
            filterDialog = true;
          "
      ...
      <div class="contentConfig__box" v-if="!isUser">
        <h2>之后加载</h2>
        <el-select
