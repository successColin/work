<template>
  <section class="configSidebar">
    <el-button-group class="configSidebar__tab" v-if="!isUser">
      <apiot-button
    ...
    <div class="configSidebar__wrapper">
      <div class="configSidebar__tabArea" v-show="curType === 1" v-if="!isUser">
        <ul
      ...
      <div class="configSidebar__tabArea" v-show="curType === 1" v-if="isUser">
        <ul
          class="configSidebar__comp"
          v-for="(group, index) in getUserCompArr"
          :key="index"
        >
          <li class="configSidebar__comp--group">
            <h1
...
export default {
      ...
      areaArr: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              statisticsType: 1, // 统计类型 1 合计 2 平均值 3 最大值 4 最小值
              statisticsComps: [], // 统计组件
              isTree: false, // 是否是树区
              ...
              lineBg: false, // 是否启用行背景色
              hasCardIcon: false, // 是否背景色相间
              bgColorArr: [], // 行背景色颜色规则数组
              mergeColumnsArr: [], /// 合并表头
              ...
              sortArr: [], // 排序数组
              sortStr: '', // 排序字符串
              enableSum: false, // 是否启用汇总
              showArea: true, // 是否显示区域
              sumType: 1, // 汇总类型 1 纵向 2 横向
              sumArr: [], // 汇总数组
              notShowArea: false, // 不显示该区域
            },
            {
            ...
            },
            {
              name: '卡片表单',
              compType: 1011,
              propertyCompName: 'CardFormConfig',
              imgUrl: 'areaComp/CardForm.svg',
              compId: createUnique(),
              compName: 'CardForm',
              pageType: 1,
              shouldTab: true,
      ...
      compArr: [
        {
          ...
          children: [
            ...
            SelectCom,
            {
              ...
              enableBtnsSearch: false, // 是否启用列表按钮区搜索
              relateCompId: '', // 关联的compId
              singleStatus: 1,
              canShow: true,
              canReadonly: false,
              width: '50%',
            ...
            },
            {
              ...
              dropDownStyle: 1, // 1 普通风格 2 背景展示风格 3 个性图标风格 4 圆点风格
            ...
            },
            {
              ...
              dragTable: true, // 能否拖入表格区
              canUser: true,
              imgUrl: 'baseComp/Switch.svg',
              compType: 34,
              compId: createUnique(),
              compName: 'SwitchForm',
              tableCompName: 'TableSwitchCol',
              propertyCompName: 'SwitchConfig',
              labelName: '开关',
              helpInfo: '', // 帮助信息
              dataSource: {
                relateName: '主表', // 关系名称
              ...
              enableTableSearch: false, // 是否启用表头搜索`
              relateCompId: '', // 关联的compId
              activeValue: null, // 启用值
              inactiveValue: null, // 关闭值
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              cascadeDataSource: [
                ...
                },
                {
                  ...
                  compId: createUnique(),
                  compName: 'Signature',
                  propertyCompName: 'SignatureConfig',
                  labelName: '签名',
                  placeholder: '签名',
                  adviseTip: '',
                  helpInfo: '',
            ...
            },
            {
              ...
              width: '50%',
              shouldRequired: false,
              thousandSign: false, // 是否启用签名色
              waterColor: '#333333', // 默认签名色
              // 签名色可选择颜色
              colors: {
                color1: '#333333',
                color2: '#E73D3D',
            ...
            },
            {
              ...
              showLabelTitle: true,
              areaType: 1,
              imgUrl: 'highComp/Scan.svg',
              compType: 32,
              compId: createUnique(),
              compName: 'InductionScan',
              propertyCompName: 'InductionScanConfig',
              placeholder: '',
              helpInfo: '',
              width: '100%',
              dividingType: 1, // 分割线显示类型
            ...
            },
            {
              ...
              showLabelTitle: true,
              areaType: 1,
              imgUrl: 'highComp/NFC.svg',
              compType: 33,
              compId: createUnique(),
              compName: 'InductionNFC',
              propertyCompName: 'InductionNFCConfig',
              placeholder: '',
              helpInfo: '',
              width: '100%',
              dividingType: 1, // 分割线显示类型
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              name: '定位',
              areaType: 1, // 表示内容区
              imgUrl: 'highComp/ApiotPosition.svg',
              compType: 29, // 29
              compId: createUnique(),
      ...
      busiArr: [
        {
          ...
          children: [
            ...
            },
            {
              name: '流程日志',
              compType: 1012,
              propertyCompName: 'FlowHisListConfig', // 组件配置渲染名称
              imgUrl: 'busiComp/FlowHisList.svg', // 组件拖拽图标
              compId: createUnique(), // 组件id
              compName: 'FlowHisList', // 真实页面组件渲染名称
              isTree: false,
              relateDataComp: {
                compId: '',
                compPath: '',
            ...
            },
            {
              name: '甘特图',
              compType: 1013,
              propertyCompName: 'GanttMainConfig',
              imgUrl: 'areaComp/TableMain.svg',
              compId: createUnique(),
              compName: 'GanttMain',
              pageType: 1,
              ...
              taskColumn: {
                ...
                cycle: { id: '', columnName: '', columnTypeDict: '' }, // 周期是否固定
                associatedColumn: {
                  id: '',
                  columnName: '',
                  columnTypeDict: '',
              ...
              viewChange: false, // 视觉切换
              timeFilter: true, // 时间过滤
              highFilter: true, // 高级过滤
              stateFilter: false, // 状态过滤
              enableAdd: false, // 启用新增
              taskDict: {},
              relateType: 1, // 弹窗类型 1是面板 2是菜单
              dialogName: 'PanelDialog', // 弹窗风格
              dialogTitle: '', // 弹窗名称
  ...
  computed: {
    getUserCompArr() {
      const userArr = [];
      this.compArr.forEach((group) => {
        if (group.canUser) {
          const obj = { ...group };
          obj.children = group.children.filter((comp) => comp.canUser);
  ...
  methods: {
    ...
    dragMove(e) {
      ...
      console.log(
        component.$attrs.isForm,
        component.$attrs.isQuery,
        component.$attrs.isCard,
      );
      ...
      // 能否拖入表单卡片
      if (component.$attrs.isCardForm) {
        if (dragElement.dragCardForm) {
          if (relateElement) {
            if (relateElement.areaType !== dragElement.areaType) {
              return false;
            }
    ...
    dragEnd(e, index) {
      this.copyNewComp(this.compArr, index, e.oldDraggableIndex);
    },
    copyNewComp(data, index, oldIndex) {
      const obj = JSON.parse(JSON.stringify(data[index].children[oldIndex]));
      obj.compId = createUnique();
      this.$set(data[index].children, oldIndex, obj);
    },
    dragAreaStart() {
      // console.log(11111);
    },
    dragAreaMove(e) {
      ...
      if (this.$route.query.isApp !== '1') {
        ...
        if (!component.$attrs.isSidebar) {
          ...
          if (
            ![1000, 1001, 1006, 1008, 1009, 1010, 1011, 1012, 1013].includes(
              dragElement.compType,
            )
          ) {
            return false;
          }
          ...
          if (
            ![1002, 1003, 1004, 1005, 1007, 1012].includes(dragElement.compType)
          ) {
            // 侧边 不是卡片跟树 不允许拖进
            return false;
          }
        ...
        ![1000, 1001, 1002, 1003, 1004, 1006, 1007].includes(
          dragElement.compType,
        )
      ) {
        return false;
