...
!(function (e, n) {
  ...
  if (!e.jWeixin) {
    ...
    var w = y.indexOf('wxdebugger') != -1;
    var T = y.indexOf('micromessenger') != -1;
    const M = y.indexOf('android') != -1;
    const P = y.indexOf('iphone') != -1 || y.indexOf('ipad') != -1;
    var x = (function () {
      const e =
    ...
    var N = {
      ...
      openCard(e) {
        for (var n = e.cardList, t = [], o = 0, r = n.length; o < r; ++o) {
          const a = n[o];
          const c = { card_id: a.cardId, code: a.code };
          t.push(c);
        }
